...
public class RecargarActivity extends AppCompatActivity {
    ...
    Button btPagar,bVolver;
    EditText etDinero;
    TextView tvTitle,tvDatosTitle,tvDinero;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btPagar = (Button)findViewById(R.id.btnPay);
        bVolver =(Button)findViewById(R.id.bVolver);
        etDinero = (EditText)findViewById(R.id.etDinero);
        tvTitle = (TextView)findViewById(R.id.tvRecargas);
        tvDatosTitle =(TextView)findViewById(R.id.tvRecargasTitle);
        tvDinero=(TextView)findViewById(R.id.tvDineroRecarga);


        btPagar.setTypeface(myFont(this));
        etDinero.setTypeface(myFont(this));
        tvTitle.setTypeface(myFont(this));
        tvDatosTitle.setTypeface(myFont(this));
        tvDinero.setTypeface(myFont(this));
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == REQUEST_CODE) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                if (!etDinero.getText().toString().isEmpty()) {
                    amount = etDinero.getText().toString();
    ...
    public void onBackPressed() {
        Intent goregistro = new Intent(RecargarActivity.this, MapsActivity.class);
        startActivity(goregistro);
        finish();
        overridePendingTransition(R.anim.slide_from_left, R.anim.slide_to_right);
    }
